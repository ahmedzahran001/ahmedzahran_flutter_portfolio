...
const List listTechnologies1 = [
  ...
  'REST API Integration (Dio & HTTP), GraphQL',
...
const List listTechnologies2 = [
  ...
  'Attention to Details & Code Quality',
  'Effective Communication and\nTechnical Presentation',
  'Time Management & Agile Productivity',
  'Teamwork, Collaboration and\nCross-functional Coordination',
  'Leadership & Mentoring Juniors',
...
const List<ExperienceModel> listExperience = [
  ExperienceModel(
    companyName: 'Professional Flutter Training',
    duration: 'Udemy | Cources',
    experiences: [
      'Flutter Advanced Course: BLoC & MVVM Pattern | 3 Sections | 92 Lectures | 15h 47m',
      'Advanced Architecture & Scalable State Management\n1- Implemented MVVM architecture & Repository Pattern in production-level Flutter applications\n2- Built scalable, testable BLoC & Cubit-based state management using feature-based structure\n3- Applied Clean Architecture & SOLID principles for maintainable codebases \n4- Integrated REST APIs using Dio with robust error handling \n5- Implemented dependency injection & service locator pattern \n6- Developed a complete production-ready Bookly App (end-to-end architecture)',
      'Complete Flutter & Dart Development Course | 15 Sections | 362 Lectures | 53h 56m',
      'Flutter Fundamentals to Real-World Applications\n1- Strong foundation in Dart programming, OOP, and null safety\n2- Built responsive UI using Material widgets, custom widgets, and animations\n3- Integrated REST APIs with Dio, async programming, and exception handling \n4- Implemented state management using Cubit & BLoC (foundation → intermediate) \n5- Built real-world applications: Store, News, Weather, Chat, Notes \n6- Integrated Firebase Auth & Firestore with real-time updates\n7- Implemented offline storage using Hive and local caching\n8- Followed professional Git workflow and published projects to GitHub',
    ],
    position: 'Flutter Developer',
  ),
  ExperienceModel(
    companyName: 'CRVD (Company)',
  ...
  ExperienceModel(
    ...
    duration: 'Internship',
    experiences: [
      'Gained hands-on experience developing mobile apps using Flutter & Dart.',
      'Learned and implemented state management, interactive UI/UX, and Firebase integration.',
      'Collaborated with team members to understand real-world app development workflows and Agile practices.',
    ],
    position: 'Flutter Developer',
  ),
  ExperienceModel(
    companyName: 'Freelancer',
    duration: 'Independent | Personal Projects',
    experiences: [
...
const List<ProjectModel> listProject = [
  ProjectModel(
    companyLink: 'https://github.com/ahmedzahran001/Bookly_App',
    companyName: 'Freelancing',
    projectDesc: [
      '🔹 Project Overview:',
      'Bookly App is a professional Flutter application built with MVVM architecture and BLoC state management, designed for browsing, searching, and managing books efficiently. It demonstrates scalable, testable, and production-ready architecture.',
      '',
      '🔹 Key Features:',
      '1- Full-featured book browsing and searching experience.',
      '2- Display detailed book information including title, author, and rating.',
      '3- Integrated Google Books API with Dio and advanced error handling.',
      '4- Feature-based modular structure for maintainability.',
      '5- State management using Cubit & Bloc for scalability and testability.',
      '6- Implemented dependency injection and service locator pattern.',
      '7- Offline caching to enhance performance and user experience.',
      '8- Custom UI design from XD mockups with animations and theming.',
      '',
      '🔹 Tech Stack:',
      'Flutter & Dart for cross-platform development.',
      'MVVM & Repository Pattern for scalable architecture.',
      'BLoC & Cubit for advanced state management.',
      'Dio for API integration and error handling.',
      'Hive & SQLite for offline caching and local storage.',
      'Responsive UI, animations, and theming for excellent UX.',
    ],
    projectLink: {
      'playstore': 'https://github.com/ahmedzahran001/Bookly_App',
      'appstore': 'https://github.com/ahmedzahran001/Bookly_App',
      // 'github': '',
    },
  ...
  ProjectModel(
    companyLink: 'https://github.com/ahmedzahran001/Homi_Real_Estate_App',
    companyName: 'Freelancing',
    projectDesc: [
      '🔹 Project Overview:',
      'Homi is a modern real estate Flutter application that allows users to browse, search, and filter properties efficiently with a sleek and responsive interface.',
      '',
      '🔹 Key Features:',
      '1- Advanced property filters including price, location, and type.',
      '2- Location-based search with map integration.',
      '3- Clean and responsive UI for mobile devices.',
      '4- Scalable state management using Provider.',
      '5- Integration with Firebase for real-time data and backend services.',
      '',
      '🔹 Tech Stack:',
      'Flutter & Dart for cross-platform development.',
      'Provider for state management.',
      'Firebase (Auth, Firestore, Messaging) for backend and real-time data.',
      'Clean architecture and modular project structure for maintainability.',
      'Responsive UI design with smooth user interactions.',
    ],
    projectLink: {
      'playstore': 'https://github.com/ahmedzahran001/Homi_Real_Estate_App',
      'appstore': 'https://github.com/ahmedzahran001/Homi_Real_Estate_App',
      // 'github': '',
    },
    projectTitle: 'Homi – Real Estate App',
  ),
  ProjectModel(
    companyLink:
